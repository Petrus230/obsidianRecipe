...
describe('Ingredient', () => {
  it('contains calories', () => {
    //arrange
    const input = `N° de,Alimentos,calories,Proteína g,Grasas g,CHO D g,CHO T g,Fibra T g,Calcio mg,Fósforo mg,Hierro mg,Magnesio mg,Zinc mg,Cobre mg,Sodio mg,Potasio mg,Vitamina A ER,b Caroteno ET,Tiamina mg,Riboflavina mg,Niacina mg,Vitamina B6 mg,Acido asc. Mg
    ,,,,,,,,,,,,,,,,,,,,,,
